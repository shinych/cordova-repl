...
cljs.core.with_meta = function with_meta(b, c) {
  ...
  return d ? with_meta.call(null, function() {
    if(void 0 === cljs.core.t3542) {
      cljs.core.t3542 = {};
      cljs.core.t3542 = function(b, c, d, e) {
        this.meta = b;
        this.o = c;
        this.with_meta = d;
        this.meta3543 = e;
      ...
      cljs.core.t3542.cljs$lang$type = !0;
      cljs.core.t3542.cljs$lang$ctorStr = "cljs.core/t3542";
      cljs.core.t3542.cljs$lang$ctorPrWriter = function(b, c) {
        return cljs.core._write.call(null, c, "cljs.core/t3542")
      };
      var d = cljs.core.t3542.prototype, f = function(b, c) {
      ...
      d.call = g;
      cljs.core.t3542.prototype.apply = function(b, c) {
        b = this;
        return b.call.apply(b, [b].concat(c.slice()))
      };
      cljs.core.t3542.prototype.cljs$core$Fn$ = !0;
      cljs.core.t3542.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta3543
      };
      cljs.core.t3542.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
        return new cljs.core.t3542(this.meta, this.o, this.with_meta, c)
      }
    }
    return new cljs.core.t3542(c, b, with_meta, null)
...
clojure.browser.repl.evaluate_javascript = function(a, b) {
  var c = function() {
    try {
      return cljs.core.PersistentArrayMap.fromArray(["\ufdd0:status", "\ufdd0:success", "\ufdd0:value", "" + cljs.core.str(eval(b))], !0)
    }catch(a) {
      if(a instanceof Error) {
        return cljs.core.PersistentArrayMap.fromArray(["\ufdd0:status", "\ufdd0:exception", "\ufdd0:value", cljs.core.pr_str.call(null, a), "\ufdd0:stacktrace", cljs.core.truth_(a.hasOwnProperty("stack")) ? a.stack : "No stacktrace available."], !0)
      }
      throw a;
    }
  }();
...
clojure.browser.repl.wrap_message = function(a, b) {
  return cljs.core.pr_str.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:type", a, "\ufdd0:content", b, "\ufdd0:order", cljs.core.swap_BANG_.call(null, clojure.browser.repl.order, cljs.core.inc)], !0))
};
...
clojure.browser.repl.connect = function(a) {
  var b = clojure.browser.net.xpc_connection.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:peer_uri", a], !0));
...
var repl = {connect:function() {
  return clojure.browser.repl.connect.call(null, "http://10.0.2.2:9001/repl")
}};
goog.exportSymbol("repl.connect", repl.connect);
repl.connect.call(null);
